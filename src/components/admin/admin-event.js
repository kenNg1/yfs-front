                  ...
                  <div className="dropdown-menu" id="dropdown-menu" role="menu">
                    <div className="dropdown-content">
                      ...
                      {COUNTRIES.map((country, index) => {
                        return (
                          <a className="dropdown-item" onClick={() => this.countryClickHandler(country)} key={index}>
                            {country.name}
                          </a>
                        );
                      })}
            ...
            <div className="modal is-active">
              ...
              <div className="modal-card">
                ...
                <footer className="modal-card-foot">
                  <button onClick={() => this.closeModal()} className="button is-success">
                    Save changes
                  </button>
...
export default connect(mapStateToProps, { getEvents: actions.getEvents })(AdminEvent);

      ...
      <div id="landing">
            ...
            <div className="columns is-desktop is-vcentered">
                <div className="column has-text-centered">
                  <OnVisible>
                    ...
                    className="subtitle is-5">Real-life experience for your CV</h4>
                </div>
                <div className="column has-text-centered">
                    <img className="logo" src={podiumImg} alt=''/>
                <h4 
                    style={{fontWeight:'500'}} 
                    className="subtitle is-5">Pitch to real investors with your business ideas</h4>
                </div>
                <div className="column has-text-centered">
                  <OnVisible>
                    ...
                    <h4
                    style={{fontWeight:'500'}}
                    className="subtitle is-5">Gain long-term mentorship & intern opportunities</h4>
                </div>
            </div>
            <div className="columns is-desktop is-vcentered">
                <div className="column has-text-centered">
                    ...
                    <h4 
                    style={{ fontWeight:'500'}}
                    className="subtitle is-5">Get international exposure and industry insights</h4>
                </div>
                <div className="column has-text-centered">
                  <OnVisible>
                    <i style={{fontSize:"310%",color:"rgb(255,157,0)"}} className="logo far fa-smile fa-5x"></i>
                  </OnVisible>
                    <h4
                      style={{fontWeight:'500'}} 
                      className="subtitle is-5">Learn in a fun, engaging way</h4>
                </div>
            </div>
          </div>
        </section>
        <section className='container-fluid thirdBackground'>
          <div className='container has-text-centered'>
            <p style={{fontFamily:"'Open Sans',sans-serif"}} className="title is-3">YFS BOOTCAMP BY THE NUMBERS</p>
            <div className="columns is-desktop is-vcentered">
              {animatedStatements}
            </div>
          </div>
        ...
        <div className='container has-text-centered'>
        <p style={{fontFamily:"'Open Sans',sans-serif"}} className="title is-3">ABOUT YOUNG FOUNDERS SCHOOL</p>
